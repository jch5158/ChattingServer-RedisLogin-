...
void CLanMonitoringClient::sendChatServerMessagePool(void)
{
	...
	packingMonitoringData(en_PACKET_SS_MONITOR_DATA_UPDATE, dfMONITOR_DATA_TYPE_CHAT_PACKET_POOL, CLockFreeObjectFreeList<CTLSLockFreeObjectFreeList<CMessage>::CChunk>::GetAllocNodeCount(), time(NULL), pMessage);
